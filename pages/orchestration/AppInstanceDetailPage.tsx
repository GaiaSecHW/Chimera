      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 font-bold text-slate-700 hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
            title="刷新"
            aria-label="刷新"
          >
                    ...
                    {isEditingLlmBindings ? (
                      <>
                        <button
                          ...
                          className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-bold text-slate-700 hover:border-slate-300 disabled:opacity-50"
                        >
                          取消
                        </button>
                        <button
                      ...
                      <button
                        ...
                        className="rounded-xl bg-slate-50 px-4 py-2 text-sm font-bold text-blue-600 hover:bg-blue-50"
                      >
                        编辑绑定
                      </button>
                    )}
                ...
                {isEditingLlmBindings ? (
                  ...
                  <div className="space-y-4">
                    {llmBindings.map((binding, index) => (
                      <div key={`${binding.provider_key}-${index}`} className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                        <div className="mb-4 flex items-center justify-between gap-3">
