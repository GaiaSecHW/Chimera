...
export const AppTemplatePage: React.FC<{ projectId: string, onNavigateToDetail: (id: string) => void }> = ({ projectId, onNavigateToDetail }) => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      await orchestrationApi.workflow.deleteAppTemplate(deletingId);
      loadTemplates();
 ...
 <div className="w-12 h-12 bg-blue-500/15 group-hover:bg-blue-500 rounded-xl flex items-center justify-center transition-all">
            ...
            <form onSubmit={handleCreate} className="flex-1 overflow-y-auto p-8 space-y-6 custom-scrollbar">
               ...
               <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full h-2 bg-theme-elevated rounded-lg appearance-none cursor-pointer accent-blue-600"
                    ...
                    {formData.service_ports.map((p, pIdx) => (
                      <div key={pIdx} className="flex gap-2 items-center">
                        ...
                        <input
                          ...
                          className="w-20 px-4 py-2 bg-theme-bg-app rounded-xl border-none outline-none text-xs font-mono"
